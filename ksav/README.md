...
- [x] **CI, running and green** — typecheck, 6,398 editor assertions, 742 engine
...
| `editor` | both | the typechecker, then 6,398 assertions across 96 files |
| `engine` | both | formatting, lints, then 742 tests across 43 binaries |
