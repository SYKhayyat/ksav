...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,638 editor assertions, 1001 tests in
...
| `editor` | both | the typechecker, then 7,638 assertions across 108 files |
| `engine` | both | formatting, lints, then 1001 tests across 69 binaries |
