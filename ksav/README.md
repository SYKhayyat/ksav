...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,530 editor assertions, 954 tests in
...
| `editor` | both | the typechecker, then 7,530 assertions across 106 files |
| `engine` | both | formatting, lints, then 954 tests across 66 binaries |
