...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,572 editor assertions, 980 tests in
...
| `editor` | both | the typechecker, then 7,572 assertions across 106 files |
| `engine` | both | formatting, lints, then 980 tests across 68 binaries |
