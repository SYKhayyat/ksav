...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 6,724 editor assertions, 810 engine
...
| `editor` | both | the typechecker, then 6,724 assertions across 98 files |
| `engine` | both | formatting, lints, then 810 tests across 46 binaries |
