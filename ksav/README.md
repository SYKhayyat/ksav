...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,632 editor assertions, 991 tests in
...
| `editor` | both | the typechecker, then 7,632 assertions across 108 files |
| `engine` | both | formatting, lints, then 991 tests across 68 binaries |
