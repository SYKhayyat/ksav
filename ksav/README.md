...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 6,516 editor assertions, 765 engine
...
| `editor` | both | the typechecker, then 6,516 assertions across 96 files |
| `engine` | both | formatting, lints, then 765 tests across 44 binaries |
