...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,275 editor assertions, 920 tests in
...
| `editor` | both | the typechecker, then 7,275 assertions across 106 files |
| `engine` | both | formatting, lints, then 920 tests across 59 binaries |
