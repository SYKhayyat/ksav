...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,262 editor assertions, 869 tests in
...
| `editor` | both | the typechecker, then 7,262 assertions across 106 files |
| `engine` | both | formatting, lints, then 869 tests across 51 binaries |
