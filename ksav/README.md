...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 6,838 editor assertions, 815 engine
...
| `editor` | both | the typechecker, then 6,838 assertions across 98 files |
| `engine` | both | formatting, lints, then 815 tests across 46 binaries |
