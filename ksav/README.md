...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,607 editor assertions, 987 tests in
...
| `editor` | both | the typechecker, then 7,607 assertions across 107 files |
| `engine` | both | formatting, lints, then 986 tests across 68 binaries |
