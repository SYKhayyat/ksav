...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,280 editor assertions, 930 tests in
...
| `editor` | both | the typechecker, then 7,280 assertions across 106 files |
| `engine` | both | formatting, lints, then 930 tests across 62 binaries |
