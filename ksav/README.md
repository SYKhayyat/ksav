...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 6,596 editor assertions, 779 engine
...
| `editor` | both | the typechecker, then 6,596 assertions across 96 files |
| `engine` | both | formatting, lints, then 779 tests across 44 binaries |
