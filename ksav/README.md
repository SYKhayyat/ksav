...
- **134 commands**, each bilingual (Hebrew + English), across styles, headings,
...
- **Word-like toolbar**, **command palette** (Ctrl+K, searches all 132 commands
...
- [x] **CI, running and green** — typecheck, 6,291 editor assertions, 695 engine
...
| `editor` | both | the typechecker, then 6,291 assertions across 96 files |
| `engine` | both | formatting, lints, then 695 tests across 43 binaries |
...
editor's scanner against Typst's own parser over **3,661**<!--=oracleDocuments--> documents, a fence that
