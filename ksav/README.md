...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 6,802 editor assertions, 812 engine
...
| `editor` | both | the typechecker, then 6,802 assertions across 98 files |
| `engine` | both | formatting, lints, then 812 tests across 46 binaries |
