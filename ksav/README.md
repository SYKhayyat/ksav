...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,633 editor assertions, 999 tests in
...
| `editor` | both | the typechecker, then 7,633 assertions across 108 files |
| `engine` | both | formatting, lints, then 999 tests across 69 binaries |
