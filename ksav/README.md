...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,592 editor assertions, 984 tests in
...
| `editor` | both | the typechecker, then 7,592 assertions across 106 files |
| `engine` | both | formatting, lints, then 984 tests across 68 binaries |
