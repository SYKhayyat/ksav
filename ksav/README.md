...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,476 editor assertions, 939 tests in
...
| `editor` | both | the typechecker, then 7,476 assertions across 106 files |
| `engine` | both | formatting, lints, then 939 tests across 63 binaries |
