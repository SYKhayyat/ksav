...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,279 editor assertions, 927 tests in
...
| `editor` | both | the typechecker, then 7,279 assertions across 106 files |
| `engine` | both | formatting, lints, then 927 tests across 61 binaries |
