...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,569 editor assertions, 978 tests in
...
| `editor` | both | the typechecker, then 7,569 assertions across 106 files |
| `engine` | both | formatting, lints, then 978 tests across 67 binaries |
