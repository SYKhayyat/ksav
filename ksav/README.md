...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,277 editor assertions, 925 tests in
...
| `editor` | both | the typechecker, then 7,277 assertions across 106 files |
| `engine` | both | formatting, lints, then 925 tests across 61 binaries |
