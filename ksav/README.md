...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,474 editor assertions, 933 tests in
...
| `editor` | both | the typechecker, then 7,474 assertions across 106 files |
| `engine` | both | formatting, lints, then 933 tests across 62 binaries |
