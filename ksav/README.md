...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,266 editor assertions, 883 tests in
...
| `editor` | both | the typechecker, then 7,266 assertions across 106 files |
| `engine` | both | formatting, lints, then 883 tests across 53 binaries |
