...
- [x] **CI, running and green** — typecheck, 6,399 editor assertions, 746 engine
...
| `editor` | both | the typechecker, then 6,399 assertions across 96 files |
| `engine` | both | formatting, lints, then 746 tests across 43 binaries |
