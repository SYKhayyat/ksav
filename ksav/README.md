...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,267 editor assertions, 894 tests in
...
| `editor` | both | the typechecker, then 7,267 assertions across 106 files |
| `engine` | both | formatting, lints, then 894 tests across 55 binaries |
