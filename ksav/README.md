...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,271 editor assertions, 908 tests in
...
| `editor` | both | the typechecker, then 7,271 assertions across 106 files |
| `engine` | both | formatting, lints, then 908 tests across 57 binaries |
