...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,565 editor assertions, 976 tests in
...
| `editor` | both | the typechecker, then 7,565 assertions across 106 files |
| `engine` | both | formatting, lints, then 976 tests across 67 binaries |
