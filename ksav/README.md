...
- [x] **CI, running and green** — typecheck, 6,286 editor assertions, 686 engine
...
| `editor` | both | the typechecker, then 6,286 assertions across 96 files |
| `engine` | both | formatting, lints, then 686 tests across 43 binaries |
