...
- [x] **CI, running and green** — `ci.yml` runs on every push and is green across
      all nine jobs: the typechecker and 7,477 editor assertions, 940 tests in
...
| `editor` | both | the typechecker, then 7,477 assertions across 106 files |
| `engine` | both | formatting, lints, then 940 tests across 63 binaries |
